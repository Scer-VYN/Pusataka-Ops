...
<body>
    <main class="auth-shell">
        ...
        <form method="POST" action="{{ route('login.store') }}">
            ...
            <input id="email" name="email" type="email" value="{{ old('email') }}" autocomplete="email" aria-invalid="{{ $errors->has('email') ? 'true' : 'false' }}" aria-describedby="email-error" required autofocus>
